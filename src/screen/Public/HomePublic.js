...
const data = [
  {
    imageUrl:
      "https://tvlk-prod-asset.imgix.net/v2/generic/C8Kj5%2FdCnE75BMxGpYYdcJVuEQbV3CnmF8ONfpQKM2nSWWBIIZYawS1qMa7rEFnfs%2Bc6JTIn%2F9eWmROh4eXx4ZssIR2KXspZq%2Fe9SQLmUa43pISCJAoXRUVJSye8FZfeChYiQzyFm1as70ls08UeLWReKWsMmCPtjfJmDLu0nKUNGRmQEL67NY1R1CjHsUI25HQN1bxZHDC2QTuZzjMjXDa1D%2Frh0amIqMAaql1HEHTOhYMjY%2BqHmYRaDW9fijWdcPLkCFSFu4zpbxyaDOY1PFK95ljjK7xoKHdv05V5Ce2ltGHZPHkJu0u6YltE%2B9U8q8tH1ZJ64VVL3o0dA6lMFryXN5KcPtv7cPXVby3hNwNL2iw5FQoTEher1oQ6Ha2oSLjDIYBoJYznu2hR8JgZGjurnveO4xcWYNBSjtYnf9oUQKVujuvhpbuMJfGeu19%2FDJblFa9UqPJszOF7QDZT0TWlpbz%2BI4u7IWotoAUkJ6BnXCYPbWGrNpFhD0iwivvkR4FI8%2FOmFJLM%2BOBjrNRq5if24T6feVhmwOewBTLxRbgrg451Plaots%2FsWKSWPk%2FsxNu2rUgSrM3pqjqZJaxcFQ%3D%3D?auto=compress%2Cformat&cs=srgb&ixlib=java-1.1.12&q=75&tv-dynamic=true",
    title: "Malang",
    id: 1
  },
  {
    imageUrl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuU1Z70DyK-V_zwPdVRiMDur14UhfWDGu7RQ18RM4OmxqVDJY-",
    title: "Jakarta",
    id: 2
  },
  {
    imageUrl:
      "https://assets-a1.kompasiana.com/items/album/2016/05/30/tugu-jogja-574c15cd83afbdc406776f50.jpg?t=o&v=1200",
    title: "Yogyakarta",
    id: 3
  },
  {
    imageUrl:
      "https://backpackerjakarta.com/wp-content/uploads/2016/09/lawang-sewu-semarang.jpg",
    title: "Semarang",
    id: 4
  },
  {
    imageUrl:
      "https://awsimages.detik.net.id/content/2016/05/05/1519/buaya.jpg",
    title: "Surabaya",
    id: 5
  },
  {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      dataSource: [
        ...
        {
          url:
            "https://static.mamikos.com/uploads/cache/data/user/2019-08-02/T71F3KDd-360x480.jpg"
        },
        {
          url:
      ...
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.body}>
            ...
            <Text
              style={{ fontWeight: "bold", fontSize: 20, color: "#000000" }}
            >
            ...
            <Button
              ...
              color="#d0d0d0"
              mode="outlined"
              onPress={() => this.props.navigation.navigate("Kostlist")}
            >
              <Text style={styles.button}>Masukan alamat atau nama tempat</Text>
            </Button>
          </View>
