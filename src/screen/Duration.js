...
export default class Duration extends Component {
  ...
  render() {
    return (
      <View style={{marginHorizontal:10,marginTop:10}}>
        ...
        <View >
          <Text style={{fontWeight:'bold',fontSize:15}}>Mulai kost berapa lama?</Text>
        </View>
 ...
 <Button color='#1BAA56' mode="contained" onPress={()=>{ this.props.navigation.navigate('Booking',{ durationtime :this.state.user.mount})}}>
     save
  </Button>
    </View>
