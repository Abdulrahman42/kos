              ...
              <View style={{flexDirection:'row'}}>
                <View style={{flex:1, marginHorizontal:5}}>
                  <View style={{marginVertical:5}}>
                    <Text style={{fontWeight:'bold', fontSize:15}}>Notifikasi</Text>
                </View>
          ...
          <Card style={styles.container2} >
            <Card.Content style={{ paddingVertical:0}}>
                  <View style={{marginVertical:10, alignItems:'center',flexDirection:'row'}}>
                   ...
                   <Text style={{fontWeight:'bold', fontSize:15, marginLeft:15,alignItems:'flex-end', flex:1 }}>Logout Akun</Text>
             </View>
          </Card.Content>
        </Card>
      </View>
